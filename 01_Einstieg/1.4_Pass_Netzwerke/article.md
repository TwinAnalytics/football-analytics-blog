...
[Article 1.5: Heatmaps](../1.5_Heatmaps/article.md)

---

*Part of **Football Analytics with Python** — a series that takes you from raw Statsbomb data to real tactical analyses.*

*Series: [1.1 The Data](../1.1_Event_Data_Einstieg/article.md) · [1.2 Drawing a Pitch](../1.2_Pitch_in_Python/article.md) · [1.3 Shot Maps](../1.3_Shot_Maps/article.md) · **1.4 Pass Networks** · [1.5 Heatmaps](../1.5_Heatmaps/article.md)*
