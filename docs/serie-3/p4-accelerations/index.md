...
Wide players tend to cluster in the upper right (high distance and high accelerations). Central defenders cluster lower right (decent distance, far fewer accelerations). Goalkeepers sit isolated at the bottom left.
...
[← P.3 Distance Analysis](../p3-distance/) · [P.5 Pressing Space →](../p5-pressing-space/)
