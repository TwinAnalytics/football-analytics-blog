...
Goalkeepers cover most of their total distance at low intensity, with almost no HSR or sprinting. Central defenders cover relatively more walking/jogging than outfield positions.
...
[← P.1 GPS Introduction](../p1-gps-intro/) · [P.3 Distance Analysis →](../p3-distance/)
